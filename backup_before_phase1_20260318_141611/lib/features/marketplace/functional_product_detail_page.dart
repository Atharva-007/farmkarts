...
class FunctionalProductDetailPage extends StatefulWidget {
  final Product product;
  final VoidCallback? onContactSeller;

  const FunctionalProductDetailPage({
    super.key,
  ...
  @override
  State<FunctionalProductDetailPage> createState() => _FunctionalProductDetailPageState();
}

class _FunctionalProductDetailPageState extends State<FunctionalProductDetailPage>
  ...
  Widget _buildQuantityButton({required IconData icon, VoidCallback? onPressed}) {
    return Container(
      decoration: BoxDecoration(
        color: onPressed != null ? AppTheme.primaryGreen.withOpacity(0.1) : Colors.grey.shade100,
        borderRadius: BorderRadius.circular(8),
        border: Border.all(
          color: onPressed != null ? AppTheme.primaryGreen.withOpacity(0.3) : Colors.grey.shade300,
        ),
      ),
      child: IconButton(
        onPressed: onPressed,
  ...
  void _contactSeller() async {
    ...
    try {
      ...
      // Simulate contact seller functionality
      await Future.delayed(const Duration(seconds: 1));
      
      _showMessage('Contact request sent to seller successfully! 📞');
      ...
      child: Column(
        ...
        children: [
          ...
          _buildDeliveryOption(
            ...
            subtitle: 'Free • Available immediately',
            isSelected: true,
          ),
          const SizedBox(height: 12),
          _buildDeliveryOption(
