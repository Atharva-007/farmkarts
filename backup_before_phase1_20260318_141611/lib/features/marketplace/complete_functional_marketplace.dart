...
class _CompleteFunctionalMarketplaceState extends State<CompleteFunctionalMarketplace>
          ...
          UniversalHeader(
            ...
            actions: [
              Container(
                ...
                child: IconButton(
                  icon: const Icon(Icons.shopping_cart_outlined, size: 22, color: Colors.white),
  ...
  /// Build search and filter section with better responsiveness
  ...
  Widget _buildFloatingActionButton() {
    ...
    return FloatingActionButton.extended(
      heroTag: 'marketplace_fab_functional',
      onPressed: _navigateToAddProduct,
      backgroundColor: AppTheme.primaryGreen,
      foregroundColor: Colors.white,
      icon: const Icon(Icons.add),
