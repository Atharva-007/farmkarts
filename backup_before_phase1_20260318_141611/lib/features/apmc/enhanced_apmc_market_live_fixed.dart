...
import 'apmc_commodity_detail_page_new.dart';
...
class _EnhancedAPMCMarketLiveFixedState extends State<EnhancedAPMCMarketLiveFixed>
  ...
  Widget _buildMarketSummary() {
    ...
    return Container(
      ...
      child: Row(
        children: [
          Expanded(
            child: _buildCompactSummaryCard('Avg', '₹${avgPrice.toStringAsFixed(0)}', Icons.trending_up, AppTheme.primaryGreen),
          ),
          const SizedBox(width: 8),
          Expanded(
                ...
                Expanded(
                  child: Column(
                    ...
                    children: [
                      ...
                      Row(
                        children: [
                          Icon(Icons.location_on, size: 12, color: AppTheme.textGrey),
  ...
  void _navigateToCommodityDetail(MarketRate commodity) {
    Navigator.push(
      context,
      MaterialPageRoute(
        builder: (context) => APMCCommodityDetailPage(commodity: commodity),
      ),
    );
  }
