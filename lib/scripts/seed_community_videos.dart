  ...
  final List<Map<String, dynamic>> videoPosts = [
    {
      ...
      'content':
          'Check out my new organic wheat farming techniques! Great results this season.',
    ...
    },
    {
      ...
      'communityType': 'farmer_community',
      'content':
          'How I increased my rice yield using smart irrigation. This video explains everything.',
    ...
    },
    {
      ...
      'content':
          'New solar-powered tractors are here! Seeing them in action in the fields.',
    ...
    },
    {
      ...
      'communityType': 'farmer_community',
      'content':
          'Drip irrigation saved my crops during the heatwave. Highly recommend watching this guide.',
