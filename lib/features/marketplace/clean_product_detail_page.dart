...
class CleanProductDetailPage extends StatefulWidget {
  final Product product;

  const CleanProductDetailPage({
    super.key,
    required this.product,
  });

  @override
  State<CleanProductDetailPage> createState() => _CleanProductDetailPageState();
}

class _CleanProductDetailPageState extends State<CleanProductDetailPage>
  ...
  Widget _buildSliverAppBar() {
    return SliverAppBar(
      ...
      actions: [
        ...
        IconButton(
          onPressed: () => _showComingSoon('Favorite'),
      ...
      children: [
        ...
        Row(
          children: [
            ...
            Text(
              widget.product.location.isEmpty ? 'Location not specified' : widget.product.location,
        ...
        children: [
          ...
          Text(
            widget.product.description.isEmpty
                ? 'Fresh and high-quality ${widget.product.name.toLowerCase()} directly from the farm. Grown using sustainable farming practices with care for the environment.'
          ...
          if (widget.product.tags.isNotEmpty) ...[
            ...
            Wrap(
              spacing: 8,
              runSpacing: 8,
              children: widget.product.tags.map((tag) => Chip(
                label: Text(
                  tag,
            ...
            children: [
              ...
              Expanded(
                child: Column(
                  ...
                  children: [
                    Text(
                      widget.product.sellerName.isEmpty
                          ? 'Farm Fresh Vendor'
              ...
              OutlinedButton(
                onPressed: () => _showComingSoon('Contact Seller'),
  ...
  void _shareProduct() {
    Share.share(
      'Check out this ${widget.product.name} for ₹${widget.product.price}/${widget.product.unit} on FarmKarts!',
    ...
    ScaffoldMessenger.of(context).showSnackBar(
      SnackBar(
        ...
        action: SnackBarAction(
          ...
          onPressed: () => _showComingSoon('Cart'),
        ),
      ),
    );
  }
            ...
            children: [
              ...
              SizedBox(
                ...
                child: ElevatedButton(
                  ...
                  child: Text(
                    'Confirm Order - ₹${(widget.product.price * _quantity).toStringAsFixed(2)}',
                    style: const TextStyle(
                      fontSize: 16,
                      fontWeight: FontWeight.bold,
                    ),
      ...
      builder: (context) => AlertDialog(
        content: Column(
          ...
          children: [
            ...
            const SizedBox(height: 8),
            Text(
              'Your order for ${widget.product.name} has been placed successfully. You will receive a confirmation shortly.',
              textAlign: TextAlign.center,
              style: TextStyle(
        ...
        actions: [
          ...
          ElevatedButton(
            onPressed: () {
              Navigator.pop(context); // Close dialog
              Navigator.pop(context); // Go back to marketplace
              _showComingSoon('Order Tracking');
            },
            style: ElevatedButton.styleFrom(
              backgroundColor: AppTheme.primaryGreen,
              foregroundColor: Colors.white,
