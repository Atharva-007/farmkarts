        ...
        children: [
          Expanded(
            child: _buildCompactStatCard(
                '12', 'Crops', Icons.agriculture, AppTheme.primaryGreen),
          ),
          const SizedBox(width: 12),
          Expanded(
            child: _buildCompactStatCard(
                '8', 'Sales', Icons.storefront, AppTheme.accentOrange),
          ),
          const SizedBox(width: 12),
          Expanded(
            child: _buildCompactStatCard('₹45K', 'Revenue',
  ...
  Widget _buildCompactStatCard(
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        border:
            isDark ? Border.all(color: AppTheme.getBorderColor(context)) : null,
        boxShadow: isDark
            ? []
            : [
                BoxShadow(
    ...
    return Column(
      children: [
        Row(
          children: [
            Expanded(
                child: _buildStatCard('Total Crops', '12', Icons.agriculture,
                    AppTheme.primaryGreen)),
            const SizedBox(width: 12),
            Expanded(
                child: _buildStatCard('Active Sales', '8', Icons.storefront,
        ...
        Row(
          children: [
            Expanded(
                child: _buildStatCard('Revenue', '₹45,230',
                    Icons.account_balance_wallet, AppTheme.success)),
            const SizedBox(width: 12),
            Expanded(
                child: _buildStatCard(
                    'Weather Alert', '3', Icons.warning, AppTheme.warning)),
          ],
        ),
      ],
    );
  ...
  Widget _buildDesktopCards() {
    return Row(
      children: [
        Expanded(
            child: _buildStatCard(
                'Total Crops', '12', Icons.agriculture, AppTheme.primaryGreen)),
        const SizedBox(width: 16),
        Expanded(
            child: _buildStatCard(
                'Active Sales', '8', Icons.storefront, AppTheme.accentOrange)),
        const SizedBox(width: 16),
        Expanded(
            child: _buildStatCard('Revenue', '₹45,230',
                Icons.account_balance_wallet, AppTheme.success)),
